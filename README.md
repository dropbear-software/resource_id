...
Flexible (e.g., 64 bits) - Allows you to choose a smaller, more performant size (like a `BIGINT`) for resources that don't require global uniqueness, optimizing database performance. Also enforces a minimum size of 1 byte to ensure valid identifiers.
